...
using PRJ_WAREHOUSE_BIVN.Common.Helper;
...
namespace PRJ_WAREHOUSE_BIVN.Data.Repositories.Implementations
{
    public class BaseRepository<T, TKey> : IBaseRepository<T, TKey> where T : class
    {
        ...
        public BaseRepository(DbContext context, IOptions<ConnectionStringOptions> options, IConfiguration configuration)
        {
            ...
            _connectionString = _connectionStringOptions.CostManagerConnection;
            _connectionWorking = _connectionStringOptions.WorkingControlConnection;
            // lấy chuỗi kết nối từ appsettings.json
            //_connectionString = configuration.GetConnectionString("CostManagerConnection");
            _conn = new SqlConnection(_connectionStringOptions.CostManagerConnection);
            _connWorking = new SqlConnection(_connectionStringOptions.WorkingControlConnection);
