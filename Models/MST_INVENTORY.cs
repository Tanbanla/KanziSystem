...

{
    public class MST_INVENTORY
    {
        ...
        public static List<MST_INVENTORY> inventory_process(MST_INVENTORY para)
        {
            ...
            var _cmd = _context.GET_DATA_FROM_SQL($" select * from KHO as a left join MATERIAL as b on a.MaNguyenLieu =  b.Material_Code where MaNguyenLieu like '%{para.MaNguyenLieu}%' and a.Group_Code = '{khoi}' and Kho like '%{para.Kho}%' and a.QTY_NEW > 0");
