...
public partial class IM_PO_DETAIL
{
    ...
    public string? CHR_SoPO_LASTEST { get; set; }

    public decimal? Dongia_SoPO_LASTEST { get; set; }

    public string? CHR_GIAITRINH_LYDO { get; set; }

    public double? FLT_TYLE_TANG { get; set; }

    public string? So_TaiSanCoDinh { get; set; }
