...
{
    [Route("QuoteSelectSection")]
    public class QuoteSelectSectionController : BaseAuthController
    {
        ...
        public QuoteSelectSectionController(
        ...
        public async Task<IActionResult> SelectQuoteSection()
        {
            ...
            return View("~/Views/Quote/SelectQuoteSection/SelectQuoteSection.cshtml", vm);
        }

        [HttpPost("SearchQuoteSection")]
            ...
            try
            {
                ...
                foreach (var maDon in selectedMaDon)
                {
                    ...
                    foreach (var item in dataList)
                    {
                        ...
                        ws.Cell(rowStart, col++).SetValue(item.NVCHR_ReasonPick);
                        col++;
