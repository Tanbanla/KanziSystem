...
{
    public class SelectQuoteController : BaseAuthController
    {
        private readonly ILogger<SelectQuoteController> _logger;
        ...
        private readonly IStringLocalizer<SelectQuoteController> _localizer;
