...
(function () {
    ...
    async function loadDetailData() {
        ...
        await callApi((window.apiBaseUrl || '') + '/InputQuotation/SearchBaoGia', {
            idRequestQuote: 0,
        ...
        // Load detail items
        callApi((window.apiBaseUrl || '') + '/InputQuotation/SearchInputQuote', {
            idRequestQuote: 0,
            maDon: window.inputQuoteDetailData?.maDon,
    ...
    function SendMail() {
        ...
        // Call API to insert
        callApi((window.apiBaseUrl || '') + '/InputQuotation/InsertInputQuote', body)
            .then(data => {
