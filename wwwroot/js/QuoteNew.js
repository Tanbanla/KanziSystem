    ...
    const app = {
        ...
        collectRowData(tr) {
            ...
            const obj = {
                ...
                CHR_LinkFile: getVal('input[name^="linkFile_"]'),
        ...
        populateRowFromDtoOptimized(tr, dto, rowIndex) {
            ...
            const fieldConfig = {
                ...
                'input[name^="linkFile"]': { value: dto.chR_LinkFile || dto.CHR_LinkFile || dto.nvchR_LinkFile, isSelect: false },
