...
function renderUserTable(data) {
    ...
    const htmlContent = data.map(mtr => {
        ...
        return `<tr>
                    ...
                    <td>${mtr.material_Name_VN}</td>
                    <td>${mtr.material_Name_EN}</td>
                    <td>${mtr.material_Name_JP}</td>
                    <td>${mtr.account_Code}</td>
                    <td>${mtr.account_Name_EN}</td>
                    <td>${mtr.account_Name_VN}</td>
                    <td>${mtr.unit}</td>
                    <td>${mtr.unit_Note}</td>
                    <td>${mtr.price}</td>
                    <td>${mtr.currency}</td>
